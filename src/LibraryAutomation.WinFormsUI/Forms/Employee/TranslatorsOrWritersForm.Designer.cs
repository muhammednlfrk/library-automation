...
partial class TranslatorsOrWritersForm
{
    /// <summary>
    ...
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TranslatorsOrWritersForm));
        ...
        _dataGridPeople = new Syncfusion.WinForms.DataGrid.SfDataGrid();
        _lblSearch = new Syncfusion.Windows.Forms.Tools.AutoLabel();
        _txtBoxSearch = new Syncfusion.Windows.Forms.Tools.TextBoxExt();
        ((System.ComponentModel.ISupportInitialize)_dataGridPeople).BeginInit();
        ...
        // _dataGridPeople
        // 
        _dataGridPeople.AccessibleName = "Table";
        _dataGridPeople.AllowEditing = false;
        _dataGridPeople.AllowFiltering = true;
        _dataGridPeople.AllowResizingColumns = true;
        _dataGridPeople.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
        _dataGridPeople.AutoSizeColumnsMode = Syncfusion.WinForms.DataGrid.Enums.AutoSizeColumnsMode.AllCells;
        _dataGridPeople.Location = new Point(5, 50);
        _dataGridPeople.Name = "_dataGridPeople";
        _dataGridPeople.Size = new Size(574, 306);
        _dataGridPeople.Style.BorderColor = Color.FromArgb(100, 100, 100);
        _dataGridPeople.Style.CheckBoxStyle.CheckedBackColor = Color.FromArgb(0, 120, 215);
        _dataGridPeople.Style.CheckBoxStyle.CheckedBorderColor = Color.FromArgb(0, 120, 215);
        _dataGridPeople.Style.CheckBoxStyle.IndeterminateBorderColor = Color.FromArgb(0, 120, 215);
        _dataGridPeople.Style.HyperlinkStyle.DefaultLinkColor = Color.FromArgb(0, 120, 215);
        _dataGridPeople.TabIndex = 40;
        _dataGridPeople.Text = "sfDataGrid1";
        _dataGridPeople.SelectionChanged += _dataGridPeople_SelectionChanged;
        // 
        // _lblSearch
        // 
        _lblSearch.DY = -19;
        ...
        Controls.Add(_dataGridPeople);
        Controls.Add(_lblSearch);
        Controls.Add(_txtBoxSearch);
        Icon = (Icon)resources.GetObject("$this.Icon");
        Name = "TranslatorsOrWritersForm";
    ...
    private Syncfusion.WinForms.DataGrid.SfDataGrid _dataGridPeople;
